...
export class Router {
  ...
  /**
   * total number of listener uids generated this session, used to create a unique listener ID for invoke responses and stream IDs
   */
  ...
  private generateStreamUid(): string {
    return this.uid + (this.listenerUidsGenerated++).toString();
  }
